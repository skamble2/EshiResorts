      ...
      <section className="mx-auto max-w-7xl px-6 py-20 sm:px-8 md:py-24">
        <Reveal className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-base leading-relaxed text-stone-soft">
            ...
            connection and quiet reflection. Nestled amidst the tranquil beauty
            of the Sahyadri hills, our recreational offerings invite guests to
            unwind, engage and create lasting memories in harmony with nature.
          </p>
        </Reveal>
        ...
        <Reveal>
          <p className="mx-auto mt-10 max-w-2xl text-center text-sm italic leading-relaxed text-stone-soft">
            ...
            an invitation to reconnect with joy, nature and each other, creating
            moments that linger long after your stay.
          </p>
        </Reveal>
      </section>
