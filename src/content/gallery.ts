...
export const gallery: GalleryImage[] = [
  ...
  { src: "/images/gallery/dining-7.jpg", alt: "The restaurant's main hall under its timber roof", category: "Dining" },
  { src: "/images/rooms/sahyadri-horizon-premium-king-room/4.jpg", alt: "Private jacuzzi bathtub with a valley-facing window", category: "Rooms" },
  { src: "/images/gallery/dining-6.jpg", alt: "Chandelier and long tables set for dinner", category: "Dining" },
  { src: "/images/rooms/shekaru-mountain-view-king-room/19.jpg", alt: "Bathroom vanity with hand-patterned tiling", category: "Rooms" },
  { src: "/images/gallery/dining-8.jpg", alt: "Banquette seating beside the restaurant bookshelves", category: "Dining" },
  { src: "/images/rooms/sahyadri-horizon-premium-king-room/16.jpg", alt: "In-room amenity tray with complimentary mineral water", category: "Rooms" },
  { src: "/images/gallery/dining-9.jpg", alt: "Daylight through the restaurant's tall windows", category: "Dining" },
  { src: "/images/rooms/shekaru-mountain-view-king-room/21.jpg", alt: "Terracotta soaking tub with a forest outlook", category: "Rooms" },
  { src: "/images/gallery/dining-12.jpg", alt: "Complimentary mineral water on the table", category: "Dining" },
  { src: "/images/rooms/prakruti-family-room/9.jpg", alt: "Patterned tilework in the Prakruti bathroom", category: "Rooms" },
  { src: "/images/gallery/dining-10.jpg", alt: "Antique gramophone by the restaurant window", category: "Dining" },
  { src: "/images/rooms/aranyam-deluxe-room/10.jpg", alt: "Vanity and mirror in the Aranyam bathroom", category: "Rooms" },
  { src: "/images/gallery/dining-13.jpg", alt: "Pool table in the restaurant lounge", category: "Dining" },
  { src: "/images/gallery/dining-11.jpg", alt: "Buffet service at the multi-cuisine restaurant", category: "Dining" },
];
